...
module "http_8080_security_group" {
  ...
  tags = {
    Terraform = "true"
    Name= "Deployment5-8080-sg-group"
  }
  ...
  ingress_with_cidr_blocks = [
    {
      ...
      to_port     = 8000
      protocol    = "tcp"
      description = " Python Application port"
...
resource "aws_instance" "web_server01" {
  ...
  tags = {
    Name = "deployment5-jenkinsServer"
  }
...
resource "aws_instance" "application_server01" {
  ...
  tags = {
    Name = "deployment5-applicationServer"
  }
